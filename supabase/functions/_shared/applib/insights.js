// Synced copy of src/lib/insights.js (trimmed to what the Telegram
// assistant's unusual-spend check needs -- topMerchants is not mirrored) --
// see scope.js in this same directory for why.
import { scopedValue } from './scope.js';
import { monthActualsByCategory } from './budget.js';
